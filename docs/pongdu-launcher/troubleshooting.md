...
| 상황 | 대처 |
| ---- | ---- |
| 게임 종료 / 서버 이탈 | 다시 접속하면 자동으로 연동 재개 |
...
## 업데이트 후 "no Qt platform plugin" 오류 창이 뜸

v5.8.0에서 v5.8.1로 업데이트할 때 한 번 뜰 수 있는 오류입니다. 창을 닫고 `PongDu.exe`를 직접 다시 실행하면 정상적으로 새 버전이 켜집니다. v5.8.1 이후 업데이트부터는 발생하지 않습니다.
