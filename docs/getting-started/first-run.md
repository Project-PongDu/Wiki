...
!!! info "업데이트 안내"
    ...
    실행 직후 **"새 버전이 있습니다"** 창이 뜨면 **지금 업데이트**를 누르세요. 자세한 내용은 [설치 — 업데이트](installation.md#update) 참고.
...
4가지가 모두 초록색이 되면 **자동으로 메인 화면으로 넘어가며 연동이 시작**됩니다. 넘어갈 때 알림음이 한 번 울립니다. 버튼을 직접 누를 필요는 없습니다.
